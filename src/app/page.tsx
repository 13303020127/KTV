...
function HomeClient() {
  const [activeTab, setActiveTab] = useState<'home' | 'favorites' | 'continueWatching'>('home');
  ...
  return (
    <PageLayout>
      <div className='px-3 sm:px-4 lg:px-6 py-4 sm:py-6 overflow-visible max-w-[100%] mx-auto'>
        {/* 顶部 Tab 切换 - 移到 Logo 上方，提升导航可见性 */}
        <div className='mb-6 flex justify-center'>
          <CapsuleSwitch
            ...
            active={activeTab}
            onChange={(value) => setActiveTab(value as 'home' | 'continueWatching' | 'favorites')}
          />
        </div>
        ...
        <div className='w-full max-w-[100%] mx-auto'>
          {activeTab === 'favorites' ? (
            ...
            <>
              ...
              {/* 热门电影 - 增强视觉层次和信息组织 */}
              <section className='mb-6 w-full bg-white dark:bg-gray-900 rounded-xl shadow-md dark:shadow-gray-800/30 overflow-hidden border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:shadow-lg p-3 sm:p-5'>
